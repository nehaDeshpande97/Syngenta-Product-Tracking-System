	...
	$qty = 1.0;
		...
		//else
			$success=no_displayed_error_result($sendtxid, multichain('sendassetfrom',
				$_POST['from'], $_POST['to'], $_POST['asset'], floatval($qty)));
...
?>						
					...
					<br>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<select class="form-control" name="to" id="to" onchange="getretailerdetails();">
<?php
...
<script>
	function getretailerdetails()
	{
		...
		xmlhttp.open("GET","getretailerdetails.php?franchiseid="+x,true);
		...
		//alert("sent");
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9"style="margin-left:50%;">
								<input style="background-color:#87ceeb;border:none;font-weight: bold;color:black;" class="btn btn-default" type="submit" name="sendasset" value="ISSUE">
							</div>
						</div>
					</form>
